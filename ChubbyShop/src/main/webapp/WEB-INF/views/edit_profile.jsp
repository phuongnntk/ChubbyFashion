...
<body>
    ...
    <section class="profile p-3">
        <div class="container rounded bg-white mt-3 mb-3">
            <form action="/edit_profile" method="post" id="edit_profile" enctype="multipart/form-data">
                <div class="py-5">
                    ...
                    <div class="col-md-8 border-right">
                        <div class="p-3 pb-5">
                            <div class="mb-3">
                                ...
                                <label  class="ml-5 border-0">${sessionScope.account.username}</label>
                            </div>
                            <div class="mb-3">
                                <label class="form-label font-weight-bold">Họ và tên</label>
                                <input name="fullname" type="text" class="form-control" value="${sessionScope.account.fullname}" placeholder="Hãy nhập họ và tên" />
                            </div>
                            <div class="row">
                                <div class="col-12 col-sm-6 col-lg-6 mb-3">
                                    <label class="form-label font-weight-bold">Giới tính</label>
                                    <select class="form-control" name="gender" id="gender" value="${sessionScope.account.isGender()}">
                                ...
                                <div class="col-12 col-sm-6 col-lg-6 mb-3">
                                    ...
                                    <input name="phone" type="text" class="form-control" value="${sessionScope.account.phone}" placeholder="Hãy nhập số điện thoại" />
                                </div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label font-weight-bold">Email</label>
                                <input name="email" type="email" class="form-control" value="${sessionScope.account.email}" placeholder="Hãy nhập Email" />
                            </div>
                            <div class="mb-3">
                                <label class="form-label font-weight-bold">Địa chỉ</label>
                                <input name="address" type="text" class="form-control" value="${sessionScope.account.address}" placeholder="Hãy nhập địa chỉ" />
                            </div>
                            <div class="mt-5">
